        ...
        <div class="row">
            ...
            <div class="col">
                @foreach ($studio as $item)
                        <h1 class="text-center mt-5">{{$item->nama}}</h1>
                        <div class="card-body">
            ...
            <div class="col col-lg-3">
                <div class="card ml-2 mb-5 mr-2" >
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            @if ($item->status==0)
                            <li class="list-group-item text-center"><button disabled="disabled" class="btn btn-success">KOSONG</button></li>
                            @else
                            <li class="list-group-item text-center"><button disabled="disabled" class="btn btn-danger">TERPAKAI</button></li>
                            @endif
                            <li class="list-group-item"><b>Harga         : {{$item->biaya}}</b></li>
                            <li class="list-group-item"><b>Peralatan      :</b>
                            <ol>
                                <li>Gitar : {{$item->gitar}}</li>
                                <li>Bass  : {{$item->bass}}</li>
                                <li>Mic   : {{$item->mic}}</li>
                            </ol></li>
                        </ul>
                    </div>
                    <div class="car-footer">
                    <a href="detail/{{$item->id}}" class="btn btn-success d-block">Booking</a>
                    </div>
                </div>
            </div>
            @endforeach
